...
def run_assignment_problem(problem):
    ...
    return assignment_model(cost=cost, tasks=tasks,people=people,opt=opt)

def get_model(seed=0):
  import random
  random.seed(seed)
  p = random.choice(list(assignment_problems))
  return run_assignment_problem(assignment_problems[p])
